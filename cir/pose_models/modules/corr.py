...
from cir.utils.geom.sampler_utils import bilinear_sampler
...
class CorrBlock:
    ...
    def __call__(self, coords):
        ...
        # --------------
        # Code block modified compared to the CIR version
        # Only gracefully handle assertion errors (other errors might happen inside CorrSampler)
